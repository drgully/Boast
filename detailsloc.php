...
<div class="navbar navbar-custom navbar-fixed-top">
 <div class="navbar-header"><a class="navbar-brand" href="/"><img src="img/logo-banner.png"> </a>
    ...
    <div class="navbar-collapse collapse">
      ...
      <form class="navbar-form" role="search" action="<?php print "detailsloc.php" ?>" method="get">
        <div class="form-group" style="display:inline;">
            <input type="hidden" name="id" value=<?php echo $_GET['id']; ?>>
            <input type="text" name="address" class="form-control" placeholder="Change start location">
...
<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="width:640px;">
  ...
  <div class="carousel-inner" role="listbox">
    <div class="item active">
      <img src="https://maps.googleapis.com/maps/api/streetview?size=640x320&heading=0&location=<?php echo $row[7].",".$row[8]; ?>" alt="">
      <div class="carousel-caption"> 
      </div>
    </div>
    <div class="item">
      <img src="https://maps.googleapis.com/maps/api/streetview?size=640x320&heading=90&location=<?php echo $row[7].",".$row[8]; ?>" alt="">
      <div class="carousel-caption"> 
      </div>
    </div>
    <div class="item">
      <img src="https://maps.googleapis.com/maps/api/streetview?size=640x320&heading=180&location=<?php echo $row[7].",".$row[8]; ?>" alt="">
      <div class="carousel-caption"> 
      </div>
    </div>
    <div class="item">
      <img src="https://maps.googleapis.com/maps/api/streetview?size=640x320&heading=270&location=<?php echo $row[7].",".$row[8]; ?>" alt="">
      <div class="carousel-caption"> 
      </div>
    </div>
  </div>
